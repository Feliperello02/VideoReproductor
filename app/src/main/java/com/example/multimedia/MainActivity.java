...
public class MainActivity extends AppCompatActivity  implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video = "android.resource://"+getPackageName()+"/"+R.raw.uzi;
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        switch (i){
            case 0:
                ...
                break;
            case 1:
                video = "android.resource://"+getPackageName()+"/"+R.raw.flash;
                break;
            case 2:
                video = "android.resource://"+getPackageName()+"/"+R.raw.atlanta;
                break;
            case 3:
                video = "android.resource://"+getPackageName()+"/"+R.raw.love;
                break;
            case 4:
                video = "android.resource://"+getPackageName()+"/"+R.raw.closer;
                break;
            case 5:
